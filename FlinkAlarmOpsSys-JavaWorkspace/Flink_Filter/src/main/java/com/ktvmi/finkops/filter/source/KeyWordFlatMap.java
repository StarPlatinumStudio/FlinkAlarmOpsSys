package com.ktvmi.finkops.filter.source;

import com.ktvmi.finkops.filter.entity.Config;
import com.ktvmi.finkops.filter.entity.InputJsonBean;
import com.ktvmi.finkops.filter.helper.KeywordHelper;
 ...
 * 自定义FlatMapFunction
 */
public class KeyWordFlatMap extends RichFlatMapFunction<String, String> {
    ...
    public KeyWordFlatMap(String serverAddr, String dataId, String group) throws NacosException {
