...
public class AlarmHelper {
    ...
    public ResponseMsg update(AlarmRuleMap alarmRule){
        ...
        AlarmRule oldRule=JSONObject.parseObject(JSON.toJSONString(alarmRuleHashMap.remove(oldKey)),AlarmRule.class);//DEBUG:com.alibaba.fastjson.JSONObject cannot be cast to AlarmRule
