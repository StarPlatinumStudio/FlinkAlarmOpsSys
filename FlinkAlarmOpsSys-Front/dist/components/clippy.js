      ...
      (function () {
        ...
        clippy.Agent.prototype = {
            ...
            this._addToQueue(function (complete) {
              ...
              if (timeout) {
                window.setTimeout($.proxy(function () {
                  if (completed) return; // exit after timeout
          ...
          _getDirection: function (x, y) {
            ...
            if (-135 <= r && r < -45) return 'Down'; // sanity check
        ...
        clippy.Animator.prototype = {
          ...
          _getNextAnimationFrame: function () {
            if (!this._currentAnimation) return undefined; // No current frame. start animation.
        ...
        clippy.load._loadMap = function (path) {
          ...
          if (dfd) return dfd; // set dfd if not defined
